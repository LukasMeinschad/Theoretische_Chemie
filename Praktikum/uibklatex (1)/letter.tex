\documentclass[german,noconfig,
%darker % uncomment for darker text (might be better for printing)
]{uibklttr}
...
% With modern Unicode LaTeX engines (xelatex, lualatex), polyglossia
% is used rather than legacy babel. Polyglossia "german" supports new
% German spelling, so use that instead of "ngerman". With pdflatex,
% "ngerman" is still supported and gives the same results as "german".
...
% % reference line
 ...
 \setkomavar{frommobilephone}{+43 512 507-0000}
